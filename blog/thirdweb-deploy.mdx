...
tags: [announcement]
summary: "A game changing tool for web3 developers"
image: "/assets/blog/thirdweb-deploy/thirdweb_deploy_banner.png"
date: "2022-05-06"
---
...
If you have a smart contract (*ERC721A, Staking, Yield Farming, your own, etc)* and want to build apps with it, this feature is for you!
...
![Deploy your contracts from the browser](/assets/blog/thirdweb-deploy/Screen_Shot_2022-04-29_at_3.19.00_PM.png)
...
![Fill in contract metadata and parameters](/assets/blog/thirdweb-deploy/Screen_Shot_2022-04-26_at_11.50.03_AM.png)
...
![Code snippets to interact with your contract from your app](/assets/blog/thirdweb-deploy/Screen_Shot_2022-04-26_at_12.01.01_PM.png)
...
![Automatic ERC721 detection generates a UI for minting and listing NFTs](/assets/blog/thirdweb-deploy/mint_contract.png)
...
- Only supports publishing and deploying on testnets (mainnet coming very soon!)
...
Once you've deployed your contract, we'd love to hear your experience. [Fill in this quick survey to help shape the future of the product!](https://forms.gle/thaCzzv6zUkDRFC67)

To chat direclty with us, Join our [Discord](http://discord.gg/thirdweb). Head to the [#general](https://discord.com/channels/834227967404146718/834227967404146721) channel and say: “i'm a builder. here for the alpha.”

We'll grant you a role to access to the [builders alpha channel](https://discord.com/channels/834227967404146718/967114171118387272) where you can share your *feedbacks* and *bug reports* to our engineering team.